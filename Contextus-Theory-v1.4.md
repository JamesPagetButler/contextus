...
*End of Theory Document v1.4. See: Contextus Specification v1.2 for implementation details. See: Contextus–CTH Bridge Specification v0.1 for external evaluation integration.*
